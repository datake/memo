...
#大きなトランスグラフを読み取り、partition_Nに分割してcsvで返す
#また、そのトランスグラフ中で正解データがあるトランスグラフ数を返す
...
answer="answer/U_K.csv"
# output_filename="partition_big/"+str(partition_N)+"_"+which_lang+".csv"
output_filename="partition_and_count1209/"+str(partition_N)+"_1209_ZUK.csv"
